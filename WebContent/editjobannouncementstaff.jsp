...
<div class="col-md-4">
<form action="<%=request.getContextPath() %>/editjobannstaff">
 ...
 <div class="form-group">
    <label for="lastname">Off/On Campus Job:</label>
    <br>
    <input type="text" class="form-control" name="on" placeholder="Edit description" value="<%=rs.getString("onoff") %>" required="required">
    
  </div>
 
 <div class="form-group">
    <label for="lastname">Email/Link:</label>
    <br>
    <input type="text" class="form-control" name="email" placeholder="Edit description" value="<%=rs.getString("emailink") %>" required="required">
