...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <jsp:include page="resourcesidebarstudent.jsp"></jsp:include>
...
<div id="container">
<div class="col-md-4">
<form action="<%=request.getContextPath() %>/reserveresourcestudent">
<%HttpSession s=request.getSession();
String a=(String)s.getAttribute("netid");
System.out.println("Reserve Resource:------"+a);
%>
...
<label for="sel1">Select Date:</label>
            <div class="hero-unit">
                <input  type="text" placeholder="click to show datepicker" name="date" id="example1" required="required">
            </div>
        </div>
