...
/**
 * Servlet implementation class viewforumstudent
 */
@WebServlet("/viewforumstudent")
public class viewforumstudent extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public viewforumstudent() {
        super();
...
HttpSession session = request.getSession();
		...
		if(c.isEmpty() )
		{
			...
			ArrayList<String> a3 = ad.checkcontent2(a1);
			...
			getServletContext().getRequestDispatcher("/forumstudent.jsp").forward(request, response);
		}
