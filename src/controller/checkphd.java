...
/**
 * Servlet implementation class checkphd
 */
@WebServlet("/checkphd")
public class checkphd extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException  {
		...
		String program=null;
			...
			if(!program.equals("Phd"))
			{
				...
				getServletContext().getRequestDispatcher("/profilesidebar.jsp").forward(request, response);
