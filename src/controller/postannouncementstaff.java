...
/**
 * Servlet implementation class postannouncementstaff
 */
@WebServlet("/postannouncementstaff")
public class postannouncementstaff extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public postannouncementstaff() {
        super();
...
*/
		...
		if(type.equals("job"))
		{
			...
			response.sendRedirect("viewjobannouncementstaff.jsp");
		}
		else
		{
			try {
