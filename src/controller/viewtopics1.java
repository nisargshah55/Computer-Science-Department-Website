...
/**
 * Servlet implementation class viewtopics1
 */
@WebServlet("/viewtopics1")
public class viewtopics1 extends HttpServlet {
	...
	try
	{
		...
		String sql2 = "select * from distopic where topic='" + id + "'";
		...
		ArrayList<String> a3 = td.checkcontent(id1);
