...
/**
 * Servlet implementation class viewtopicsstudent
 */
@WebServlet("/viewtopicsstudent")
public class viewtopicsstudent extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public viewtopicsstudent() {
        super();
...
String id=request.getParameter("selectid");
	...
	try
	{
		...
		ArrayList<String> a3 = td.checkcontent2(id1);
		...
		session.setAttribute("topic", id1);
		response.sendRedirect("forumstudent.jsp");
	}
		catch (Exception e)
