...
/**
 * Servlet implementation class reserveresourcestudent
 */
@WebServlet("/reserveresourcestudent")
public class reserveresourcestudent extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public reserveresourcestudent() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(rd.checkreservation(resource, date, schedule))
		{
			...
			getServletContext().getRequestDispatcher("/reserveresourcestudent.jsp").forward(request, response);
		...
		response.sendRedirect("viewresourcestudent.jsp");
		}
