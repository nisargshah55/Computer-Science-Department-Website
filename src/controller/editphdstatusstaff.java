...
/**
 * Servlet implementation class editphdstatusstaff
 */
@WebServlet("/editphdstatusstaff")
public class editphdstatusstaff extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public editphdstatusstaff() {
        super();
